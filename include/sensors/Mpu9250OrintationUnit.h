...
class Mpu9250OrintationUnit : public OrintationUnit {
private:
...
public:
    Mpu9250OrintationUnit(float axesRotation = 0, bool accelCorrection = true);

    void getMetrics6(double *pAngleX, double *pAngleY, double *pAngleZ, long *pAccX, long *pAccY, long *pAccZ);
    void getAngularSpeed(double& angularSpeedX, double& angularSpeedY, double& angularSpeedZ);
    void resetAngles();
